...
document.querySelectorAll('.skill-category, .project-card, .about-text, .education-card').forEach(el => {
    observer.observe(el);
});
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        // Create mailto link
        const mailtoLink = `mailto:shanthankompally12@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
// Add click event to theme toggle button (if exists)
